...
public class HelloController {
    ...
    public void initialize(){
        ...
        lstInfografiki.getSelectionModel().selectedIndexProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observableValue, Number number, Number t1) {
                ...
                if (index != -1){
                    selInfografika = igList.inforgrafiki.get(index);
                    txtAdresStrony.setText(igList.inforgrafiki.get(index).adresStrony);
                    Image image = new Image(igList.inforgrafiki.get(index).adresMiniaturki);
    ...
    public void btnOpenFileAction(ActionEvent actionEvent) {
        ...
        if (file != null){
            ...
            for (Infografika ig: igList.inforgrafiki) tytuly.add(ig.tytul);
    ...
    public void btnPokazOnAction(ActionEvent actionEvent){
        ...
        try {
            FXMLLoader loader = new FXMLLoader(ImgViewer.class.getResource("imgViewer.fxml"));
